        ...
        <View>
            <View style={style.fevbox}>
                ...
                <View style={style.detailsbox}>
                    <Text style={{ fontSize: 10, marginLeft: 5, marginTop: 15 , color :'black'}}>LIME</Text>
                    <Text style={{ fontSize: 18, color: 'black', marginLeft: 5, marginTop: 5 , fontWeight : '500'}}>{Product}</Text>
